...
const faqs = [
  ...
  },
  {
    question: '阶段奖如何获得？',
    answer:
      '阶段奖分三个阶段提前发放：6/24 评选「最佳选题潜力奖」，发放 1 个 Vibecoding 键盘；7/1 评选「最佳 MVP 原型奖」，发放 1 个 Vibecoding 键盘；7/8 评选「社区影响力奖」，发放 1 张 WAIC 门票。已获阶段奖团队不再参与后续阶段奖评选，对应礼品顺延至下一支符合条件的队伍。',
  },
  {
    question: '奖励如何发放？',
    answer:
      '阶段奖将在对应阶段公布时同步发放（其中 WAIC 门票将提前发放，以便获奖代表安排行程）。云资源或 API 额度将在 7 月 15 日结果公示后统一发放。KnowS 与 StepFun 专项权益将按对应合作方确认的领取流程、发放形式与使用规则执行。',
  },
  {
    question: '如何加入交流群？',
